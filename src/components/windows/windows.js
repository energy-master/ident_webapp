    ...
    return (
        ...
        >
            ...
            <Draggable
                ...
                handle=".window-header" // Only drag by the header
            >
                <div ref={nodeRef} style={{ width: '45%', left: '40%', top: '80%', position: 'absolute' }}>
                    {/* <div className="window-header" > */}
                    <div>
                        <div className="window-header" style={{
                            width: '50px', height: '25px', background: '#292D39', backgroundColor: '#292D39', bgcolor: '#292D39', color: 'white', left: '91%', position: 'absolute', zIndex: 100, cursor: 'pointer', textAlign: 'center'
                        ...
                        <Accordion sx={{ bgcolor: '#292D39', color: '#efeff1ff', width: '90%' }}>
                            <AccordionSummary
                                ...
                                id="panel3-header"
                            >
                                <Typography component="span">Simulation</Typography>
                            </AccordionSummary>
                            <AccordionDetails>
            ...
            <Draggable
                ...
                handle=".window-header" // Only drag by the header
            >
                <div ref={nodeRef} style={{ width: '30%', left: '60%', top: '70%', position: 'absolute' }}>
                    {/* <div className="window-header" > */}
                    <div>
                        <div className="window-header" style={{
                            width: '50px', height: '25px', background: '#292D39', backgroundColor: '#292D39', bgcolor: '#292D39', color: 'white', left: '91%', position: 'absolute', zIndex: 100, cursor: 'pointer', textAlign: 'center'
                        ...
                        <Accordion sx={{ bgcolor: '#292D39', color: '#efeff1ff', width: '90%' }}>
                            <AccordionSummary
                                ...
                                id="panel3-header"
                            >
                                <Typography component="span">Model DB</Typography>
                            </AccordionSummary>
                            <AccordionDetails>
                                <ConnectedModelData />
                            </AccordionDetails>
